// The streamed UIMessage contract shared with the chat service's browser. The
// orchestration loop here PRODUCES these parts; the chat app CONSUMES them. Keep
// this type in sync with packages/chat/src/lib/agents/ui-messages.ts — the two
// services don't share a package (true split), so the shape is duplicated.
